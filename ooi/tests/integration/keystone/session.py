...
IP_SERVER="192.92.149.119"


class KeySession(object):

    def __init__(self, auth_url = 'https://192.92.149.119:5000/v2.0'):
    ...
    def create_request_ssl(self, app, path="/", environ={}, headers=None, base_url="/v2.0", **kwargs):
        environ ["HTTP_X-Auth-Token"]= app.auth_token #"4cf9e807516c450fa98f320f4a9f431a
        kwargs["http_version"] = "HTTP/1.1"
        kwargs["server_name"] = IP_SERVER
        kwargs["server_port"] = "9696"
